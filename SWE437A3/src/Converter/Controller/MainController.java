...
public class MainController {
    ...
    public void handleConvertButton() {
    	...
    	// use to calculate decimal point
        ...
        // Convert mph to
        if (Mph.getText() != null && .getLength() > 0) {
            newvals.put("",Float.toString(convertMph2(Mph.getText(), point)));
        }
        if (Kmh.getText() != null && Kmh.getLength() > 0) {
            newvals.put("Kmh",Float.toString(convertKmh2Mph(Kmh.getText(), point)));
        }
	...
	private void printForm(Properties newvals) {
        ...
        //Set text field of Mph clear Pound
        if (newvals.getProperty ("Mph") != null)
        {
            Mph.setText(newvals.getProperty ("Mph"));
            Kmh.setText(null);
        }

        //Set text field of Kmh clear Pound
        if (newvals.getProperty ("Kmh") != null)
        {
            Kmh.setText(newvals.getProperty ("Kmh"));
            Mph.setText(null);
        }
